...
namespace RBV_AccesoDatos
{
    ...
    partial void DeletecaracteristicaRecursoValioso(caracteristicaRecursoValioso instance);
        ...
        public RBVDataContext() :
            base(System.Configuration.ConfigurationManager.ConnectionStrings["LocalSqlServer"].ToString(), mappingSource)
        {
            OnCreated();
        }
	...
	public partial class Calificacion
	{
		...
		[Column(Storage="_IdCalificacion", AutoSync=AutoSync.Always, DbType="Int NOT NULL IDENTITY", IsDbGenerated=true)]
		...
		[Column(Storage="_Valor", DbType="SmallInt NOT NULL")]
		public short Valor
		{
			get
			{
    ...
    partial void OnAccionesChanging(string value);
    partial void OnAccionesChanged();
    partial void OnValorDefaultChanging(decimal value);
    partial void OnValorDefaultChanged();
		...
		[Column(Storage="_ValorDefault", DbType="Decimal(18,2) NOT NULL")]
		public decimal ValorDefault
		{
			get
			{
			...
			set
			{
				if ((this._ValorDefault != value))
				{
					this.OnValorDefaultChanging(value);
					this.SendPropertyChanging();
					this._ValorDefault = value;
					this.SendPropertyChanged("ValorDefault");
					this.OnValorDefaultChanged();
				}
			}
		}
