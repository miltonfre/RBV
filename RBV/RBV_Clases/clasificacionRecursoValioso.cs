//------------------------------------------------------------------------------
// Clase clasificacionRecursoValioso generada automáticamente con CrearClaseSQL
// de la tabla 'clasificacionRecursoValioso' de la base 'RBV'
// Fecha: 19/ago/2013 00:01:02
//
...
//
public class clasificacionRecursoValioso{
    ...
    private System.String _clasificacionRV;
    //
    ...
    public System.String clasificacionRV{
        get{
            return ajustarAncho(_clasificacionRV,50);
        }
        set{
            _clasificacionRV = value;
        }
    }
