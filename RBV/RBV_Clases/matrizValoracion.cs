//------------------------------------------------------------------------------
// Clase matrizValoracion generada automáticamente con CrearClaseSQL
...
public class matrizValoracion{
    ...
    public string Actualizar(){
        ...
        //       yo uso el idTipoRecurso que es el identificador único de cada registro
    ...
    public string Actualizar(string sel){
        ...
        ////       Ese campo, (en mi caso idTipoRecurso) será el que hay que poner al final junto al WHERE.
